...
<head>
    <title>Trousers for Women</title>
</head>
    ...
    <div class="content-page">
        ...
        <form action="" method="GET">
            ...
            <div class="card-body">
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Trousers' and gender = 'Women' group by brand ";
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Trousers' and gender = 'Women' group by color ";
                $brand_query_run  = mysqli_query($con, $brand_query);
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Trousers' and gender = 'Women' group by price ";
                $brand_query_run  = mysqli_query($con, $brand_query);
        ...
        <div class="showcase">
            ...
            if (isset($_GET['colors'])) {
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'Women' and type = 'Trousers' and color IN ('$rowbrand')";
            ...
            ?>
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'Women' and type = 'Trousers' and price IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'Women' and type = 'Trousers' and brand IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                ...
                $results_per_page = 41;
                $query = "SELECT * FROM clothes WHERE gender = 'Women' and type = 'Trousers' ";
                $result = mysqli_query($con, $query);
                $number_of_result = mysqli_num_rows($result);
                ...
                $products = "SELECT * FROM clothes WHERE gender = 'Women' and type = 'Trousers' LIMIT " . $page_first_result . ',' . $results_per_page;
                $products_run = mysqli_query($con, $products);



                // $products = "SELECT * FROM clothes where type = 'Trousers' and gender = 'Women'";
                // $products_run = mysqli_query($con, $products);
                if (mysqli_num_rows($products_run) > 0) {
                    foreach ($products_run as $proditems) :
                        ?>
