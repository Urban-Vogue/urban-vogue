    ...
    <div class="content-page">
        ...
        <form action="" method="GET">
            ...
            <div class="card-body">
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Top' and gender = 'women' group by color ";
                $brand_query_run  = mysqli_query($con, $brand_query);
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Top' and gender = 'women' group by price ";
                $brand_query_run  = mysqli_query($con, $brand_query);
        ...
        <div class="showcase">
            ...
            if (isset($_GET['colors'])) {
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'Top' and color IN ('$rowbrand')";
            ...
            ?>
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'Top' and price IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'Top' and brand IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                ...
                $results_per_page = 41;
                $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'Top' ";
                $result = mysqli_query($con, $query);
                $number_of_result = mysqli_num_rows($result);
                ...
                $products = "SELECT * FROM clothes WHERE gender = 'women' and type = 'Top' LIMIT " . $page_first_result . ',' . $results_per_page;
                $products_run = mysqli_query($con, $products);
                    ...
                    foreach ($products_run as $proditems) :
                        ...
                        <div class="page-number">
                            ...
                            for ($page = 1; $page <= $number_of_page; $page++) {
                                echo '<a style = "text-decoration: none; color: black; font-weight: bold; font-size: 18px; border: 1px solid black; padding: 2px; text-align: center; font-family: Calibri" href = "Top.php?page=' . $page . ' ">' . $page . '&nbsp </a>';
                            }
                            ?>
                        </div>
            <?php
