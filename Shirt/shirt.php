    ...
    <div class="content-page">
        ...
        <form action="" method="GET">
            ...
            <div class="card-body">
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Shirt' and gender = 'Men' group by brand ";
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Shirt' and gender = 'men' group by color ";
                $brand_query_run  = mysqli_query($con, $brand_query);
                ...
                $brand_query = "SELECT * FROM clothes where type = 'Shirt' and gender = 'men' group by price ";
                $brand_query_run  = mysqli_query($con, $brand_query);
        ...
        <div class="showcase">
            ...
            if (isset($_GET['colors'])) {
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'men' and type = 'Shirt' and color IN ('$rowbrand')";
            ...
            ?>
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'men' and type = 'Shirt' and price IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'men' and type = 'Shirt' and brand IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                ...
                $results_per_page = 41;
                $query = "SELECT * FROM clothes WHERE gender = 'men' and type = 'Shirt' ";
                $result = mysqli_query($con, $query);
                $number_of_result = mysqli_num_rows($result);
                ...
                $products = "SELECT * FROM clothes WHERE gender = 'men' and type = 'Shirt' LIMIT " . $page_first_result . ',' . $results_per_page;
                $products_run = mysqli_query($con, $products);



                // $products = "SELECT * FROM clothes where type = 'Shirt' and gender = 'men'";
                // $products_run = mysqli_query($con, $products);
                if (mysqli_num_rows($products_run) > 0) {
                    foreach ($products_run as $proditems) :
                        ?>
