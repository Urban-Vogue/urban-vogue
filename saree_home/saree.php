...
<!DOCTYPE html>
<link rel="stylesheet" href="../kurta_home/style.css">
...
<body>
    <div class="title-div">
        ...
        <div id="v"></div>
        <span class="title" style="margin-left: -20px;">ogue</span>
            ...
            <ol>
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <b>Festive Wear</b>
                        <ul>
                            <a href="#main.php">Kurta</a>
                            <a href="#">Patiala</a>
                            <a href="#" style="padding-bottom: 10px;">Dhoti</a>
                        </ul>
                    </div>
                </li>
                <li class="dropdown">
                    ...
                    <div class="dropdown-content" style="margin-left: -40px;">
                        ...
                        <ul>
                            <a href="#">Kurta</a>
                            <a href="#">Sharara</a>
                            <a href="#" style="padding-bottom: 10px;">Saree</a>
                        </ul>
                    </div>
                </li>
                <li>KIDS</li>
                ...
                <li>ABOUT US</li>
                <li class="dropdown">
                    <a href="javascript:void(0)" style="margin-left: 20px; text-decoration: none;color: black;"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;&nbsp;Your Profile</a>
                </li>
            </ol>
        </div>
    </div>
    <section class="imag"  style="background: url('1.jpg')"></section>
    ...
    <div class="content-page">
        ...
        <form action="" method="GET">
            ...
            <div class="card-body">
                ...
                $brand_query = "SELECT * FROM clothes where type = 'saree' and gender = 'women' group by brand ";
                ...
                $brand_query = "SELECT * FROM clothes where type = 'saree' and gender = 'women' group by color ";
                $brand_query_run  = mysqli_query($con, $brand_query);
                ...
                $brand_query = "SELECT * FROM clothes where type = 'saree' and gender = 'women' group by price ";
                $brand_query_run  = mysqli_query($con, $brand_query);
        ...
        <div class="showcase">
            ...
            if (isset($_GET['colors'])) {
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'saree' and color IN ('$rowbrand')";
                    ...
                    $products = "SELECT * FROM clothes WHERE gender = 'women' and color IN ('$rowbrand') LIMIT " . $page_first_result . ',' . $results_per_page;
            ...
            ?>
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'saree' and price IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                    ...
                    $products = "SELECT * FROM clothes WHERE gender = 'women' and price IN ('$rowbrand') LIMIT " . $page_first_result . ',' . $results_per_page;
                    $products_run = mysqli_query($con, $products);
                    if (mysqli_num_rows($products_run) > 0) {
                        foreach ($products_run as $proditems) :
                        ?>
                ...
                foreach ($branchecked as $rowbrand) {
                    $results_per_page = 80;
                    $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'saree' and brand IN ('$rowbrand')";
                    $result = mysqli_query($con, $query);
                    $number_of_result = mysqli_num_rows($result);
                    ...
                    $products = "SELECT * FROM clothes WHERE gender = 'women' and brand IN ('$rowbrand') LIMIT " . $page_first_result . ',' . $results_per_page;
                    $products_run = mysqli_query($con, $products);
                    if (mysqli_num_rows($products_run) > 0) {
                        foreach ($products_run as $proditems) :
                        ?>
                ...
                $results_per_page = 41;
                $query = "SELECT * FROM clothes WHERE gender = 'women' and type = 'saree' ";
                $result = mysqli_query($con, $query);
                $number_of_result = mysqli_num_rows($result);
                ...
                $products = "SELECT * FROM clothes WHERE gender = 'women' and type = 'saree' LIMIT " . $page_first_result . ',' . $results_per_page;
                $products_run = mysqli_query($con, $products);
                    ...
                    foreach ($products_run as $proditems) :
                        ...
                        <div class="page-number">
                            ...
                            for ($page = 1; $page <= $number_of_page; $page++) {
                                echo '<a style = "text-decoration: none; color: black; font-weight: bold; font-size: 18px; border: 1px solid black; padding: 2px; text-align: center; font-family: Calibri" href = "saree.php?page=' . $page . ' ">' . $page . '&nbsp </a>';
                            }
                            ?>
                        </div>
            <?php
